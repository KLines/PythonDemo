...
'''
1、函数参数中的冒号是参数的类型建议符，告诉程序员希望传入的实参的类型
2、"->" 是返回值的注释，-> str 意思即是提醒函数使用者返回值会是一个str型
'''
...
func1(excute)
print(func1.__doc__)  # 通过 函数名.__doc__ 的方式来显示函数的说明文档
...
temp = func4
print("temp = func4")
temp(excute)  # 将函数赋值给一个变量，并调用
del func4  # 删除函数，其实就是删除引用，函数内容仍然存在
# func4(excute) # 不能执行
print("del func4")
temp(excute)
